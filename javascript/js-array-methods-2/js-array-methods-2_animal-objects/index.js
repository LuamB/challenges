...
console.log(
  "first animal name starting with letter g: ",
...
console.log(
  "idx of first animal with name length of more than 5: ",
...
console.log(
  "animal names sorted alphabetically: ",
...
console.log(
  "animal weight sorted from low to high: ",
...
const animalsSortedByWeightReversed = animals
  ...
  .reverse();
console.log(
  "animal weight sorted from high to low: ",
...
console.log(
  "any animal with weight more than 500? ",
...
console.log(
  "all European animals weigh less than 100? ",
...
const weightOfAllAnimalsInAfrica = animals
  ...
  .reduce((a, b) => a + b);
console.log("weight of all African animals: ", weightOfAllAnimalsInAfrica);
...
console.log(
  "avg. weight of all African animals: ",
